...
$Sources = @(
    ...
    (Join-Path $SrcRoot "zombie\inventory\ItemContainer.java"),
    ...
    (Join-Path $SrcRoot "zombie\iso\WorldReuserThread.java"),
    (Join-Path $SrcRoot "zombie\vehicles\BaseVehicle.java"),
    (Join-Path $SrcRoot "zombie\vehicles\VehicleManager.java"),
    ...
    (Join-Path $SrcRoot "zombie\entity\components\fluids\FluidContainerUpdateSystem.java"),
    ...
    (Join-Path $SrcRoot "zombie\characters\animals\AnimalPopulationManager.java"),
...
$ClassFiles = @(
    ...
    "zombie\network\ServerMap`$FinalizeBoundaryGetSquare.class",
    "zombie\network\ServerMap`$PhaseAResult.class",
    "zombie\network\ServerMap`$ServerCell.class",
    "zombie\network\ServerMap`$ServerCell`$LoadState.class",
