...
public final class PlayerDownloadServer {
    ...
    public void update() {
        ...
        int apocBrWaitingBefore = this.ccrWaiting.size();
        int apocBrRequests = 0;
        int apocBrPreparedChunks = 0;
        try {
            ...
            ApocBRServerTelemetry.recordChunkMain(apocBrWaitingBefore, apocBrRequests, apocBrPreparedChunks, System.nanoTime() - apocBrStart);
        }
    }
    ...
    public final class WorkerThread extends Thread {
        ...
        private void sendArray(ClientChunkRequest ccr) throws IOException {
            long apocBrStart = System.nanoTime();
            int apocBrChunks = ccr.chunks.size();
            try {
            for (int n = 0; n < ccr.chunks.size(); n++) {
                ClientChunkRequest.Chunk reqChunk = ccr.chunks.get(n);
            ...
            this.freeRequests.add(ccr);
                ...
                ApocBRServerTelemetry.recordChunkWorker(apocBrChunks, System.nanoTime() - apocBrStart);
            }
        }
