...
public class ExtraInfoPacket implements INetworkPacket {
    ...
    public void processServer(PacketTypes.PacketType packetType, UdpConnection connection) {
        ...
        // ApocBR Patch: Reject isForced packets from non-admin players
        // Prevents exploit where modified clients send isForced=true to bypass capability checks
        if (this.isForced && !connection.getRole().hasAdminPower()) {
