...
public final class IngameState extends GameState {
    ...
    public void UpdateStuff() {
        ...
        ApocBRServerTelemetry.recordStateUpdateSection("gameTime", System.nanoTime() - apocBrStateSectionStart);
        ...
        if (!this.paused) {
            try (GameProfiler.ProfileArea ex = profiler.profile("ScriptManager.update")) {
                ...
                ApocBRServerTelemetry.recordStateUpdateSection("script", System.nanoTime() - apocBrStateSectionStart);
            }
        }

        if (!this.paused) {
            try (GameProfiler.ProfileArea var55 = profiler.profile("WorldSoundManager.update")) {
                apocBrStateSectionStart = System.nanoTime();
                WorldSoundManager.instance.update();
                ApocBRServerTelemetry.recordStateUpdateSection("worldSound", System.nanoTime() - apocBrStateSectionStart);
            } catch (Exception var54) {
                ExceptionLogger.logException(var54);
            }

            try (GameProfiler.ProfileArea var56 = profiler.profile("IsoFireManager.Update")) {
                apocBrStateSectionStart = System.nanoTime();
                IsoFireManager.Update();
                ApocBRServerTelemetry.recordStateUpdateSection("fire", System.nanoTime() - apocBrStateSectionStart);
            } catch (Exception var52) {
                ExceptionLogger.logException(var52);
            }

            try (GameProfiler.ProfileArea var57 = profiler.profile("RainManager.Update")) {
                apocBrStateSectionStart = System.nanoTime();
                RainManager.Update();
                ApocBRServerTelemetry.recordStateUpdateSection("rain", System.nanoTime() - apocBrStateSectionStart);
            } catch (Exception var50) {
                ExceptionLogger.logException(var50);
            }

            try (GameProfiler.ProfileArea var58 = profiler.profile("Meta.update")) {
                apocBrStateSectionStart = System.nanoTime();
                Meta.instance.update();
                ApocBRServerTelemetry.recordStateUpdateSection("meta", System.nanoTime() - apocBrStateSectionStart);
            }

            try {
                try (GameProfiler.ProfileArea var59 = profiler.profile("VirtualZombieManager.update")) {
                    apocBrStateSectionStart = System.nanoTime();
                    VirtualZombieManager.instance.update();
                    ApocBRServerTelemetry.recordStateUpdateSection("virtualZombie", System.nanoTime() - apocBrStateSectionStart);
                }

                try (GameProfiler.ProfileArea var60 = profiler.profile("MapCollisionData.updateMain")) {
                    apocBrStateSectionStart = System.nanoTime();
                    MapCollisionData.instance.updateMain();
                    ApocBRServerTelemetry.recordStateUpdateSection("mapCollisionMain", System.nanoTime() - apocBrStateSectionStart);
                }

                try (GameProfiler.ProfileArea var61 = profiler.profile("ZombiePopulationManager.updateMain")) {
                    apocBrStateSectionStart = System.nanoTime();
                    ZombiePopulationManager.instance.updateMain();
                    ApocBRServerTelemetry.recordStateUpdateSection("zombiePopulationMain", System.nanoTime() - apocBrStateSectionStart);
                }

                try (GameProfiler.ProfileArea var62 = profiler.profile("PathfindNative.checkUseNativeCode")) {
                    apocBrStateSectionStart = System.nanoTime();
                    PathfindNative.instance.checkUseNativeCode();
                    ApocBRServerTelemetry.recordStateUpdateSection("pathfindCheck", System.nanoTime() - apocBrStateSectionStart);
                }

                if (PathfindNative.useNativeCode) {
                    try (GameProfiler.ProfileArea var63 = profiler.profile("PathfindNative.updateMain")) {
                        apocBrStateSectionStart = System.nanoTime();
                        PathfindNative.instance.updateMain();
                        ApocBRServerTelemetry.recordStateUpdateSection("pathfindMain", System.nanoTime() - apocBrStateSectionStart);
                    }
                } else {
                    try (GameProfiler.ProfileArea var64 = profiler.profile("PolygonalMap2.updateMain")) {
                        apocBrStateSectionStart = System.nanoTime();
                        PolygonalMap2.instance.updateMain();
                        ApocBRServerTelemetry.recordStateUpdateSection("polygonalMap", System.nanoTime() - apocBrStateSectionStart);
                    }
                }
            ...
            try (GameProfiler.ProfileArea var65 = profiler.profile("LootRespawn.update")) {
                apocBrStateSectionStart = System.nanoTime();
                LootRespawn.update();
                ApocBRServerTelemetry.recordStateUpdateSection("lootRespawn", System.nanoTime() - apocBrStateSectionStart);
            ...
            if (GameServer.server) {
                ...
                ApocBRServerTelemetry.recordStateUpdateSection("serverManagers", System.nanoTime() - apocBrStateSectionStart);
            }
            ...
            if (!GameServer.server) {
                try {
                    try (GameProfiler.ProfileArea var66 = profiler.profile("ItemSoundManager.update")) {
                        ItemSoundManager.update();
                    }

                    try (GameProfiler.ProfileArea var67 = profiler.profile("LoopedRangedWeaponSounds.update")) {
                        LoopedRangedWeaponSounds.INSTANCE.update();
                    }

                    try (GameProfiler.ProfileArea var68 = profiler.profile("FliesSound.update")) {
                        FliesSound.instance.update();
                    }

                    try (GameProfiler.ProfileArea var69 = profiler.profile("CorpseFlies.update")) {
                        CorpseFlies.update();
                    }

                    try (GameProfiler.ProfileArea var70 = profiler.profile("WorldMapVisited.update")) {
            ...
            try (GameProfiler.ProfileArea var71 = profiler.profile("SearchMode.update")) {
                SearchMode.getInstance().update();
            }

            try (GameProfiler.ProfileArea var72 = profiler.profile("RenderSettings.update")) {
    ...
    private GameStateMachine.StateAction updateInternal() {
        ...
        ApocBRServerTelemetry.recordStateUpdateSection("evenPausedLua", System.nanoTime() - apocBrStateSectionStart);
        ...
        if (Core.exiting) {
            ...
            try {
                ...
                if (!this.paused || GameClient.client) {
                    try {
                        ...
                        ApocBRServerTelemetry.recordStateUpdateSection("isoWorld", System.nanoTime() - apocBrStateSectionStart);
                        ...
                        try (GameProfiler.ProfileArea var36 = profiler.profile("GEM Update")) {
                            ...
                            ApocBRServerTelemetry.recordStateUpdateSection("gem", System.nanoTime() - apocBrStateSectionStart);
                        }

                        try (GameProfiler.ProfileArea var37 = profiler.profile("Animal")) {
                            apocBrStateSectionStart = System.nanoTime();
                            AnimalController.getInstance().update();
                            ApocBRServerTelemetry.recordStateUpdateSection("animal", System.nanoTime() - apocBrStateSectionStart);
                        }
                        ...
                        try (GameProfiler.ProfileArea var38 = profiler.profile("Radio")) {
                            ...
                            ApocBRServerTelemetry.recordStateUpdateSection("radio", System.nanoTime() - apocBrStateSectionStart);
                        }

                        try (GameProfiler.ProfileArea var39 = profiler.profile("Stuff")) {
                            apocBrStateSectionStart = System.nanoTime();
                            this.UpdateStuff();
                            ApocBRServerTelemetry.recordStateUpdateSection("updateStuff", System.nanoTime() - apocBrStateSectionStart);
                        }

                        try (GameProfiler.ProfileArea var40 = profiler.profile("On Tick")) {
                            apocBrStateSectionStart = System.nanoTime();
                            this.onTick();
                            ApocBRServerTelemetry.recordStateUpdateSection("onTickLua", System.nanoTime() - apocBrStateSectionStart);
                        }
                        ...
                        if (objAmbEmit != null) {
                            ...
                            ApocBRServerTelemetry.recordStateUpdateSection("ambient", System.nanoTime() - apocBrStateSectionStart);
                        }
            ...
            if (GameClient.client || GameServer.server) {
                try (GameProfiler.ProfileArea var35 = profiler.profile("Update Managers")) {
                    apocBrStateSectionStart = System.nanoTime();
                    updateManagers();
                    ApocBRServerTelemetry.recordStateUpdateSection("updateManagers", System.nanoTime() - apocBrStateSectionStart);
                }
            }
