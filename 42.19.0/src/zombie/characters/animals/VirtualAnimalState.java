...
public abstract class VirtualAnimalState {
    ...
    public void addAnimalTracks(AnimalTracksDefinitions.AnimalTracksType trackType) {
        if (trackType != null) {
            if (!this.animal.apocBrShouldAddTrack(AnimalZones.getVirtualAnimalFrame(), this.animal.apocBrGetTrackIntervalFrames())) {
                ApocBRServerTelemetry.recordVirtualAnimalTrackAttempt(false);
                return;
            }
            ...
            if (chunk != null) {
                ...
                ApocBRServerTelemetry.recordVirtualAnimalTrackAttempt(true);
    ...
    void moveAlongPath(String action, float distance) {
        AnimalZone closestZone = this.animal.zone;
        if (closestZone == null || action != null && !action.equals(closestZone.action)) {
            closestZone = AnimalZones.getInstance().getClosestZone(this.animal.x, this.animal.y, action);
            this.animal.zone = closestZone;
        }

        if (closestZone == null) {
            this.animal.zone = null;
    ...
    public static class StateEat extends VirtualAnimalState {
        ...
        public void update() {
            ...
            if (worldAgeHours - this.animal.eatStartTime > this.animal.timeToEat / 60.0F) {
                this.animal.setState(new VirtualAnimalState.StateMoveFromEat(this.animal));
        ...
        public void update() {
            ...
            if (!this.animal.isRemoved()) {
                ...
                if ("Eat".equals(this.animal.currentZoneAction) && this.animal.isTimeToEat()) {
                    this.animal.setState(new VirtualAnimalState.StateMoveToEat(this.animal));
                } else {
                    this.checkNextRestTime();
                    if ("Sleep".equals(this.animal.currentZoneAction) && this.animal.isTimeToSleep()) {
                        this.animal.setState(new VirtualAnimalState.StateMoveToSleep(this.animal));
                    } else {
    ...
    public static class StateMoveFromEat extends VirtualAnimalState {
        ...
        public AnimalZoneJunction visitJunction(AnimalZone zone, boolean bEndPoint, ArrayList<AnimalZoneJunction> junctions) {
            ...
            if (junction == null) {
                ...
                this.animal.setState(new VirtualAnimalState.StateFollow(this.animal));
                return junction;
            }
        }
    }
    ...
    public static class StateMoveToEat extends VirtualAnimalState {
        ...
        public void reachedEnd() {
            this.animal.setState(new VirtualAnimalState.StateEat(this.animal));
        }
    }
    ...
    public static class StateMoveToSleep extends VirtualAnimalState {
        ...
        @Override
        public void reachedEnd() {
            this.animal.setState(new VirtualAnimalState.StateSleep(this.animal));
        }
    }
    ...
    public static class StateSleep extends VirtualAnimalState {
        ...
        public void update() {
            ...
            if (worldAgeHours > this.animal.wakeTime) {
                ...
                this.animal.setState(new VirtualAnimalState.StateMoveFromSleep(this.animal));
