...
public final class AnimalChunk {
    ...
    private long apocBrNextTracksCleanupFrame;
    ...
    public void updateTracks() {
        this.apocBrUpdateTracks(AnimalZones.getVirtualAnimalFrame());
    }

    public void apocBrUpdateTracks(long frameCounter) {
        if (!this.animalTracks.isEmpty()) {
            if (frameCounter < this.apocBrNextTracksCleanupFrame) {
                return;
            }

            this.apocBrNextTracksCleanupFrame = frameCounter + 32L;
            long removed = 0L;
            ...
            ApocBRServerTelemetry.recordVirtualAnimalTrackCleanup(removed);
        }
    }
    ...
    public void addTracks(VirtualAnimal animal, AnimalTracksDefinitions.AnimalTracksType trackType) {
        if (animal.zone != null || AnimalZones.getClosestZoneDist(animal.x, animal.y) <= 20.0F) {
