...
public final class AnimalZones {
    ...
    private static long apocBrVirtualAnimalFrame;
    ...
    static long getVirtualAnimalFrame() {
        return apocBrVirtualAnimalFrame;
    }
    ...
    public static void updateVirtualAnimals() {
        ...
        for (AnimalChunk chunk : instance.chunksWithTracksSet) {
            ApocBRServerTelemetry.recordVirtualAnimalChunk(chunk.animals.isEmpty(), !chunk.animalTracks.isEmpty());
            instance.tempAnimalList.clear();
            PZArrayUtil.addAll(instance.tempAnimalList, chunk.animals);
            chunk.apocBrUpdateTracks(apocBrVirtualAnimalFrame);
            ...
            for (int i = 0; i < instance.tempAnimalList.size(); i++) {
                ...
                if (animal.isRemoved()) {
                    ...
                    String apocBrStateName = animal.apocBrGetStateName();
                    if (animal.apocBrShouldUpdate(apocBrVirtualAnimalFrame)) {
                        ApocBRServerTelemetry.recordVirtualAnimalUpdate(apocBrStateName, false);
                        animal.update();
                    } else {
                        ApocBRServerTelemetry.recordVirtualAnimalUpdate(apocBrStateName, true);
                    }
                }
            }
        }
