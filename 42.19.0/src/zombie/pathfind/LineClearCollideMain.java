...
final class LineClearCollideMain {
    ...
    /**
     * PolygonalMap2 shares one LineClearCollideMain instance. Its points, vectors and
     * PointPool are mutable scratch state, so concurrent server-side animal updates
