...
public class ClimateManager {
    ...
    public ClimateManager() {
        ...
        try {
            ...
            DebugType.General.printException(var2, var2.getMessage(), LogSeverity.Error);
        }
    }
        ...
        if (!GameClient.client && !GameServer.server) {
            ...
            switch (type) {
                case 0:
                    ...
                    return true;
                case 1:
                    this.weatherPeriod.writeNetWeatherData(bbw);
                    return true;
                case 2:
                    this.thunderStorm.writeNetThunderEvent(bbw);
                    return true;
                case 3:
                    return true;
                case 4:
                ...
                case 7:
                    ...
                    bbw.putBoolean(this.netInfo.isStopWeather);
                    bbw.putBoolean(this.netInfo.isTrigger);
                    bbw.putBoolean(this.netInfo.isGenerate);
                    bbw.putFloat(this.netInfo.triggerDuration);
                    bbw.putBoolean(this.netInfo.triggerStorm);
                    bbw.putBoolean(this.netInfo.triggerTropical);
                    bbw.putBoolean(this.netInfo.triggerBlizzard);
                    bbw.putFloat(this.netInfo.generateStrength);
                    bbw.putInt(this.netInfo.generateFront);
                    return true;
                default:
                    return false;
            }
