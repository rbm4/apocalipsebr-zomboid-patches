                ...
                for (int wy = mapCell.cy * 32; wy < (mapCell.cy + 1) * 32; wy++) {
                    ...
                    if (inFile.exists()) {
                        ...
                        try {
                            ...
                            DebugType.General.printException(var13, "Error load chunk on coordinates " + wx + "," + wy, LogSeverity.Error);
                        }
                        ...
                        try {
                            ...
                            DebugType.General.printException(var12, "Error save chunk on coordinates " + wx + "," + wy, LogSeverity.Error);
                        }
