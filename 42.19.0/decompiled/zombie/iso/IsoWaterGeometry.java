...
public final class IsoWaterGeometry {
    ...
    public IsoWaterGeometry init(IsoGridSquare square) throws Exception {
        ...
        this.x[0] = IsoUtils.XToScreen(square.x + dx0, square.y, square.z, 0);
        this.y[0] = IsoUtils.YToScreen(square.x + dx0, square.y, square.z, 0);
        this.x[1] = IsoUtils.XToScreen(square.x + dx0, square.y + 1 + dy1, square.z, 0);
        this.y[1] = IsoUtils.YToScreen(square.x + dx0, square.y + 1 + dy1, square.z, 0);
        this.x[2] = IsoUtils.XToScreen(square.x + 1, square.y + 1 + dy1, square.z, 0);
        this.y[2] = IsoUtils.YToScreen(square.x + 1, square.y + 1 + dy1, square.z, 0);
