    ...
    private static void limitPing() {
        ...
        for (UdpConnection connection : GameServer.udpEngine.connections) {
            ...
            if (doKick(connection, ping)) {
                ...
                DebugType.Multiplayer.warn("Kick: player=\"%s\" type=\"%s\"", connection.getUserName(), "UI_OnConnectFailed_Ping");
                DebugType.Multiplayer.debugln("Ping: limit=%d/%d average-%d=%d", pingLimit, pingLimitCount, pingIntervalCount, ping);
            }
