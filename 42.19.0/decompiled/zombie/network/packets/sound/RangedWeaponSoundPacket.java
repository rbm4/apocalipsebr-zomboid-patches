...
public class RangedWeaponSoundPacket implements INetworkPacket {
    ...
    public void processClient(UdpConnection connection) {
        ...
        emitter.setParameterValue(instance, FMODManager.instance.getParameterDescription("FirearmInside"), this.firearmInside);
        emitter.setParameterValue(instance, FMODManager.instance.getParameterDescription("FirearmRoomSize"), this.firearmRoomSize);
        emitter.setParameterValue(instance, FMODManager.instance.getParameterDescription("LocalPlayer"), 0.0F);
