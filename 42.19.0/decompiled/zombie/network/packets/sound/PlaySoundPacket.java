...
public class PlaySoundPacket implements INetworkPacket {
    ...
    private static final ParameterMeleeHitSurface.Material[] MATERIAL = ParameterMeleeHitSurface.Material.values();
    ...
    public void setData(Object... values) {
        ...
        this.material = values.length > 3 ? (ParameterMeleeHitSurface.Material)values[3] : null;
    }
        ...
        if (movingObject instanceof IsoGameCharacter isoGameCharacter) {
            ...
            if (!this.isLooped()) {
                if (this.isVocal() && isoGameCharacter instanceof IsoPlayer player) {
                    ...
                    if (this.material != null && isoGameCharacter instanceof IsoPlayer player) {
                        player.setMeleeHitSurface(this.material);
                    }
    ...
    public void parse(ByteBufferReader b, IConnection connection) {
        ...
        byte ordinal = b.getByte();
        this.material = ordinal >= 0 && ordinal < MATERIAL.length ? MATERIAL[ordinal] : null;
    }
    ...
    public void write(ByteBufferWriter b) {
        ...
        b.putByte(this.material == null ? -1 : this.material.ordinal());
    }
