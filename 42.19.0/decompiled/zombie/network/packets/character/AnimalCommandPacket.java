    ...
    public void write(ByteBufferWriter b) {
        ...
        if (AnimalCommandPacket.Type.UpdateGenome == this.type) {
            ...
            try {
                ...
                DebugType.Multiplayer.printException(var7, "Animal genome write failed", LogSeverity.Error);
                b.position(sizePos);
                b.putInt(0);
            }
        } else {
            ...
            if (this.item != null) {
                ...
                try {
                    ...
                    DebugType.Multiplayer.printException(var6, "AnimalInventoryItem save failed", LogSeverity.Error);
                }
            } else {
                b.putInt(-1);
            }
    ...
    public void parse(ByteBufferReader b, IConnection connection) {
        ...
        if (AnimalCommandPacket.Type.UpdateGenome == this.type) {
            ...
            try {
                ...
                DebugType.Multiplayer.printException(var7, "Animal genome read failed", LogSeverity.Error);
                return;
            }
        } else {
            ...
            if (itemID != -1) {
                try {
                    ...
                    DebugType.Multiplayer.printException(var6, "AnimalInventoryItem load failed", LogSeverity.Error);
                }
            }
        }
    }
            ...
            switch (this.type) {
                ...
                case RemoveAndGrabAnimalFromTrailer:
                    if (this.animalId.isConsistent(connection)
                        ...
                        InventoryItem var13 = this.item;
                        if (var13 instanceof InventoryItem) {
                            this.playerId.getPlayer().getInventory().AddItem(var13);
                            this.playerId.getPlayer().setPrimaryHandItem(var13);
                            this.playerId.getPlayer().setSecondaryHandItem(var13);
                            this.animalId.getAnimal().itemId = this.item.id;
                            if (var13 instanceof AnimalInventoryItem animalItem) {
                ...
                case FeedAnimalFromHand:
                    if (this.animalId.isConsistent(connection) && this.playerId.isConsistent(connection)) {
                        InventoryItem var19 = this.item;
                        if (var19 instanceof InventoryItem) {
                            this.animalId.getAnimal().feedFromHand(this.playerId.getPlayer(), var19);
                        } else {
