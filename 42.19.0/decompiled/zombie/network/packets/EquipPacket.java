        ...
        if (!GameClient.client || this.player.getPlayer() != null) {
            if (GameClient.client) {
                ...
                if (primaryHand == EquipPacket.HandStatus.Nothing) {
                    ...
                    try {
                        primaryHandItem = InventoryItem.loadItem(b.bb, 247);
                        ...
                        if (hasVisual == 1) {
                            primaryHandItem.getVisual().load(b.bb, 247);
                        }
                ...
                if (secondaryHand == EquipPacket.HandStatus.Nothing) {
                    ...
                    try {
                        secondaryHandItem = InventoryItem.loadItem(b.bb, 247);
                        if (this.player.getPlayer().isLocalPlayer()) {
                        ...
                        byte hasVisual = b.getByte();
                        if (hasVisual == 1) {
                            secondaryHandItem.getVisual().load(b.bb, 247);
                        }
