...
public class CutawayAttachedModifier implements Consumer<TextureDraw> {
    ...
    public void accept(TextureDraw textureDraw) {
        ...
        float x2;
        float x1 = x2 = PZMath.min(tex0.offsetX + tex0.getWidth(), tex1.offsetX + tex1.getWidth(), (float)(tex2OffsetX + tex2Width));
        float y1;
        float y0 = y1 = PZMath.max(tex0.offsetY, tex1.offsetY, (float)tex2OffsetY);
        float y3;
        float y2 = y3 = PZMath.min(tex0.offsetY + tex0.getHeight(), tex1.offsetY + tex1.getHeight(), (float)(tex2OffsetY + tex2Height));
