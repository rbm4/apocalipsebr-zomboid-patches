    ...
    private void OnAnimEvent_PlayTripSound(IsoGameCharacter owner, AnimEvent event) {
        if (SoundManager.instance.isListenerInRange(owner.getX(), owner.getY(), 70.0F)) {
            ...
            if (fence != null) {
                ...
                owner.getEmitter().setParameterValue(instance, FMODManager.instance.getParameterDescription("TripObstacleType"), tripType.getValue());
            }
        }
    }
        ...
        if (SoundManager.instance.isListenerInRange(owner.getX(), owner.getY(), 70.0F)) {
            ...
            if (fence != null) {
                if (owner instanceof IsoZombie) {
                    ...
                    owner.getEmitter().setParameterValue(instance, FMODManager.instance.getParameterDescription("FenceTypeLow"), fenceType.getValue());
                }
            }
        }
    }
