...
public final class PathFindBehavior2 implements IPathfinder {
    ...
    public void pathToCharacter(IsoGameCharacter target) {
        ...
        if (target.isSittingOnFurniture() && (target.getSquare().isSolid() || target.getSquare().isSolidTrans())) {
            ...
            switch (dir) {
                case N:
                    IsoGridSquare sqN = IsoWorld.instance.getCell().getGridSquare((double)(x + 0.5F), (double)(y - 0.3F), (double)z);
                    ...
                    break;
                case S:
                    IsoGridSquare sqS = IsoWorld.instance.getCell().getGridSquare((double)(x + 0.5F), (double)(y + 1 + 0.3F), (double)z);
                    ...
                    break;
                case W:
                    IsoGridSquare sqW = IsoWorld.instance.getCell().getGridSquare((double)(x - 0.3F), (double)(y + 0.5F), (double)z);
                    ...
                    break;
                case E:
                    IsoGridSquare sqE = IsoWorld.instance.getCell().getGridSquare((double)(x + 1 + 0.3F), (double)(y + 0.5F), (double)z);
