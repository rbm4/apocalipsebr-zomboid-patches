...
public final class Food extends InventoryItem {
    ...
    private void updateTemperature() {
        float dt = GameServer.server ? (float)(System.currentTimeMillis() - this.lastUpdateTime) / 10.0F : 1.0F;
        this.temperatureTimeAccum = this.temperatureTimeAccum + GameTime.getInstance().getThirtyFPSMultiplier() * dt;
