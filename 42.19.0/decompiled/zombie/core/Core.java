...
public final class Core {
    ...
    private static final GameVersion gameVersion = new GameVersion(42, 19, "");
    ...
    private final int VERSION_DISABLE_WIND_SPRITE_EFFECTS = 8;
    ...
    private final StringConfigOption optionGamepadBindingPreset = this.newOption("gamepadBindingPreset", "Default", this::onOptionGamepadBindingPresetChanged);
    ...
    private String upgradeOptionValue(String optionName, String optionValue, int version) {
        return version < 8 && Objects.equals(optionName, "doWindSpriteEffects") ? "false" : optionValue;
    }
    ...
    public boolean invalidBindingShiftCtrl(Core.KeyBinding keyB) {
        ...
        if (keyB.altKey() >= 10000 && Mouse.isButtonDownUICheck(keyB.altKey() - 10000)) {
            return false;
        } else if (keyB.keyValue() >= 10000 && Mouse.isButtonDownUICheck(keyB.keyValue() - 10000)) {
            return false;
        } else if (keyB.keyValue() == 0 && keyB.altKey == 0) {
            return true;
        } else if (keyB.keyValue() == 42 || keyB.keyValue() == 54) {
            return !shiftDown;
    ...
    public String getGitSha() {
        if (this.gitSha == null) {
            this.gitSha = IS_DEV ? DevMainScreenState.getDevSha() : "1aa820d7bb66c4e55513cae04022bdacdac5b34e";
        }
    ...
    public String getGitRevision() {
        if (this.gitRevisionString == null) {
            if (IS_DEV) {
                ...
                this.gitRevisionString = "1aa820d7bb66c4e55513cae04022bdacdac5b34e"
                    .substring(0, Math.min("1aa820d7bb66c4e55513cae04022bdacdac5b34e".length(), 20));
            }
        }
    ...
    public static String getGitRevisionString() {
        return IS_DEV ? core.getGitRevision() : "1aa820d7bb66c4e55513cae04022bdacdac5b34e 2026-06-01 09:40:02 (ZB)";
    }
