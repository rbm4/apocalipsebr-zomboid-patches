        ...
        if ((this.contentFlag & flagUpdateFish) != 0) {
            ...
            if (hasFish) {
                try {
                    ...
                    this.currentFish.load(b.bb, 247);
                    this.currentFishItem = InventoryItem.loadItem(b.bb, 247);
                } catch (Exception var5) {
                    DebugType.Objects.printException(var5, this.getDescription(), LogSeverity.Error);
                }
            } else {
        ...
        if ((this.contentFlag & flagUpdateFish) != 0) {
            if (b.putBoolean(this.currentFishItem != null)) {
                try {
                    ...
                    DebugType.Objects.printException(var3, this.getDescription(), LogSeverity.Error);
                }
            }
