        ...
        if (this.sourceId.containerType == ContainerID.ContainerType.IsoObject) {
            ...
            if (this.destinationId.containerType == ContainerID.ContainerType.IsoObject) {
                ...
                if (this.destinationId.getContainer() == null) {
                    ...
                    return this.sourceId.containerType != ContainerID.ContainerType.Floor
                        || !(IsoUtils.DistanceTo(this.sourceId.x, this.sourceId.y, this.playerId.getPlayer().getX(), this.playerId.getPlayer().getY()) > 1.1);
                }
            }
        }
    }
