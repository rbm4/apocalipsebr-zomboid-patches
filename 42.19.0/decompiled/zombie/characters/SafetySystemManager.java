...
public class SafetySystemManager {
    ...
    public static void storeSafety(IsoPlayer player) {
        try {
            ...
            DebugType.Multiplayer.printException(var3, "StoreSafety failed", LogSeverity.Error);
        }
    }
    ...
    public static void restoreSafety(IsoPlayer player) {
        try {
            ...
            DebugType.Multiplayer.printException(var2, "RestoreSafety failed", LogSeverity.Error);
        }
    }
