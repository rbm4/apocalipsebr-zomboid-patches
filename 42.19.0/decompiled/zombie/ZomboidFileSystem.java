...
public final class ZomboidFileSystem {
    ...
    public boolean tryDeleteFile(String filePath) {
        if (StringUtils.isNullOrWhitespace(filePath)) {
            ...
            try {
                ...
                DebugType.FileIO.printException(var3, String.format("Failed to delete file: \"%s\"", filePath), LogSeverity.General);
                return false;
            }
        }
    }
    ...
    public void cleanMultiplayerSaves() {
        ...
        try {
            ...
            DebugType.FileIO.printException(var12, var12.toString(), LogSeverity.Warning);
        }
    }
