...
public final class PropertyContainer extends TShortShortHashMap {
    ...
    private static final Object addPropertiesTieLock = new Object();
    ...
    public synchronized void CreateKeySet() {
        if (this.isEmpty()) {
            this.keyArray = null;
        } else {
    ...
    public void AddProperties(PropertyContainer other) {
        ...
        if (thisHash < otherHash) {
            synchronized (this) {
                synchronized (other) {
                    this.addPropertiesLocked(other);
                }
            }
            ...
            synchronized (addPropertiesTieLock) {
                synchronized (this) {
                    synchronized (other) {
                        this.addPropertiesLocked(other);
                    }
    ...
    private void addPropertiesLocked(PropertyContainer other) {
    ...
    public synchronized boolean has(IsoFlagType flag) {
    ...
    public synchronized void set(String propName, String propValue, boolean checkIsoFlagType) {
        if (propName != null) {
            if (checkIsoFlagType) {
    ...
    public synchronized void set(IsoFlagType flag) {
        if (flag.index() / 64 == 0) {
    ...
    public synchronized void unset(String propName) {
        int p = TilePropertyAliasMap.instance.getIDFromPropertyName(propName);
    ...
    public synchronized void unset(IsoFlagType flag) {
        if (flag.index() / 64 == 0) {
            this.spriteFlags1 = this.spriteFlags1 & ~(1L << flag.index() % 64);
        } else {
            this.spriteFlags2 = this.spriteFlags2 & ~(1L << flag.index() % 64);
    ...
    public synchronized boolean has(String isoPropertyType) {
        int p = TilePropertyAliasMap.instance.getIDFromPropertyName(isoPropertyType);
        return this.containsKey((short)p);
    }

    public synchronized ArrayList<IsoFlagType> getFlagsList() {
    ...
    public synchronized int getSurface() {
        this.initSurface();
        return this.surface;
    }

    public synchronized boolean isSurfaceOffset() {
        this.initSurface();
    ...
    public synchronized boolean isTableTop() {
        this.initSurface();
        return (this.surfaceFlags & 8) != 0;
    }

    public synchronized int getStackReplaceTileOffset() {
        this.initSurface();
    ...
    public synchronized IsoDirections getSlopedSurfaceDirection() {
        this.initSurface();
        return this.slopedSurfaceDirection;
    }

    public synchronized int getSlopedSurfaceHeightMin() {
        this.initSurface();
        return this.slopedSurfaceHeightMin;
    }

    public synchronized int getSlopedSurfaceHeightMax() {
        this.initSurface();
