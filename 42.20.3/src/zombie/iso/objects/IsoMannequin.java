...
public class IsoMannequin extends IsoObject implements IHumanVisual {
    ...
    public void saveState(ByteBuffer output) throws IOException {
        if (!this.init || StringUtils.isNullOrWhitespace(this.modelScriptName)) {
            this.initOutfit();
        }
    ...
    public void render(float x, float y, float z, ColorInfo col, boolean bDoChild, boolean bWallLightingPass, Shader shader) {
        ...
        if (this.animate) {
            ...
            if (FBORenderChunkManager.instance.isCaching()) {
                ...
                if (perPlayerx.renderDirection != null) {
                    this.setForwardIsoDirection(perPlayerx.renderDirection);
                ...
                if (perPlayerxx.renderDirection != null) {
                    dir = perPlayerxx.renderDirection;
                ...
                perPlayerxx.lastRenderDirection = dir;
    ...
    private void syncModel() {
        ...
        if (StringUtils.isNullOrWhitespace(this.modelScriptName)) {
            ...
            if (StringUtils.isNullOrWhitespace(this.animSet)) {
                this.animSet = "mannequin";
            }

            if (StringUtils.isNullOrWhitespace(this.animState)) {
                this.animState = this.female ? "female" : "male";
            }
        }

        this.humanVisual.setForceModelScript(this.modelScriptName);
        String modelScript = this.modelScriptName;
        switch (modelScript) {
            case "FemaleBody":
