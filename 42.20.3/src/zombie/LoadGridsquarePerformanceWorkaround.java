...
public final class LoadGridsquarePerformanceWorkaround {
    private static final boolean APocBRLazyServerContainerLoad = Boolean.parseBoolean(System.getProperty("apocbr.lazyServerContainerLoad", "true"));
        ...
        public void checkObject(IsoObject object) {
            ...
            if (sprite != null && sprite.getName() != null) {
                ...
                if (container != null && !container.isExplored()) {
                    if (GameServer.server && LoadGridsquarePerformanceWorkaround.APocBRLazyServerContainerLoad) {
                        return;
                    }
