...
public class AnimalGene {
        ...
        if (animal.adef.genes != null) {
            ...
            if (forcedGenes != null) {
                for (String key : forcedGenes.keySet()) {
                    ...
                    AnimalGenomeDefinitions def = AnimalGenomeDefinitions.getDefinition(name);
                    if (def == null) {
            ...
            for (String s : animal.fullGenome.keySet()) {
                ...
                AnimalGenomeDefinitions def = AnimalGenomeDefinitions.getDefinition(gene.name);
    ...
    public static void doMutation(AnimalAllele allele) {
        ...
        if (StringUtils.isNullOrEmpty(allele.geneticDisorder) && Rand.Next(100) <= 2) {
            ArrayList<String> geneticDisorders = AnimalGenomeDefinitions.getGeneticDisorderList();
            if (!geneticDisorders.isEmpty()) {
                allele.geneticDisorder = geneticDisorders.get(Rand.Next(0, geneticDisorders.size()));
            }
        }
