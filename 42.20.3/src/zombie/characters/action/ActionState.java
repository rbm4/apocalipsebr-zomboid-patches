...
public final class ActionState implements IAnimationVariableSourceContainer {
    ...
    public void parse(File file) {
        ...
        try {
            ...
            DebugType.ActionSystem.printException(var8, "Error loading: " + filePath, LogSeverity.Error);
        }
    }
    ...
    private void parseActionState(Element root) {
        try {
            ...
            DebugType.ActionSystem.printException(var3, "Exception thrown parsing ActionState.", LogSeverity.Error);
        }
    }
