...
public final class MapObjects {
    ...
    public static void newGridSquare(IsoGridSquare square) {
        ...
        for (int i = 0; i < objects.size(); i++) {
            ...
            if (obj != null && !(obj instanceof IsoWorldInventoryObject) && obj.sprite != null) {
                String spriteName = obj.sprite.name == null ? obj.spriteName : obj.sprite.name;
                if (spriteName != null && !spriteName.isEmpty() && onNew.containsKey(spriteName)) {
                    tempObjects.add(obj);
                }
            }
        }
        ...
        for (int i = 0; i < tempObjects.size(); i++) {
            ...
            if (objects.contains(obj) && obj.sprite != null) {
                String spriteName = obj.sprite.name == null ? obj.spriteName : obj.sprite.name;
                if (spriteName != null && !spriteName.isEmpty()) {
                    MapObjects.Callback callback = onNew.get(spriteName);
                    if (callback != null) {
                        ...
                        for (int n = 0; n < callback.functions.size(); n++) {
                            ...
                            if (!objects.contains(obj) || obj.sprite == null || !callback.spriteName.equals(spriteName)) {
                                break;
                            }
                        }
                    }
    ...
    public static void loadGridSquare(IsoGridSquare square) {
        ...
        for (int i = 0; i < objects.size(); i++) {
            ...
            if (obj != null && !(obj instanceof IsoWorldInventoryObject) && obj.sprite != null) {
                String spriteName = obj.sprite.name == null ? obj.spriteName : obj.sprite.name;
                if (spriteName != null && !spriteName.isEmpty() && onLoad.containsKey(spriteName)) {
                    tempObjects.add(obj);
                }
            }
        }
