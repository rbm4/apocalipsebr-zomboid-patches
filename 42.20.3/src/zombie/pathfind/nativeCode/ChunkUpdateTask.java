...
// Original: zombie.pathfind.nativeCode.ChunkUpdateTask (Build 42.20.1)
...
class ChunkUpdateTask implements IPathfindTask {
    ...
    static final ObjectPool<ChunkUpdateTask> pool = new ObjectPool<>(ChunkUpdateTask::new, "ChunkUpdateTask.pool", 2048);
