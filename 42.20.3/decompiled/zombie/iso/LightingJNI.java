            ...
            for (BaseVehicle vehicle : IsoWorld.instance.currentCell.getVehicles()) {
                if (vehicle.vehicleId != -1) {
                    for (int jx = 0; jx < vehicle.getLightCount(); jx++) {
                        ...
                        checkTorch(part, 4096 + vehicle.vehicleId * 10 + jx);
                    }
                }
            }
                                        ...
                                        for (int ix = 0; ix < sq.getSpecialObjects().size(); ix++) {
                                            ...
                                            if (object instanceof IsoCurtain curtain) {
                                                ...
                                                if (!door.isOpen() && door.HasCurtains() != null && !door.isCurtainOpen()) {
                                                    float curtainRx = 0.0F;
                                                    float curtainGx = 0.0F;
                                                    float curtainBx = 0.0F;
                                                    float curtainIntensityx = 0.33F;
                                                    if (door.getNorth()) {
    ...
    public static void update() {
        if (IsoWorld.instance != null && IsoWorld.instance.currentCell != null) {
            ...
            if (checkLightsFuture != null) {
                ...
                try (GameProfiler.ProfileArea var26 = profiler.profile("checkLights")) {
                    checkLights();
                }
            }
            ...
            try (GameProfiler.ProfileArea var28 = profiler.profile("DeadBodyAtlas")) {
