...
public final class Core {
    ...
    public String getVersion() {
        return gameVersion + ".3 " + getGitRevisionString();
    }
    ...
    public String getGitRevision() {
        if (this.gitRevisionString == null) {
            if (IS_DEV) {
                ...
                this.gitRevisionString = "70207f62e0".substring(0, Math.min("70207f62e0".length(), 20));
            }
        }
    ...
    public static String getGitRevisionString() {
        return IS_DEV ? core.getGitRevision() : "70207f62e0";
    }
