        ...
        if (tex == null || tex.isReady()) {
            if (a != 0.0F) {
                ...
                if (this.texture1Cutaway == null && this.texture2Cutaway == null) {
                    ...
                    float tex0OffsetX = tex == null ? 0.0F : tex.offsetX;
                    float tex0OffsetY = tex == null ? 0.0F : tex.offsetY;
                    int tex0Width = tex == null ? 128 : tex.getWidth();
                    int tex0Height = tex == null ? 256 : tex.getHeight();
                    ...
                    if (tex != null) {
                        ...
                        u0 = (tex.getXStart() * widthHW + (x0 - tex0OffsetX)) / widthHW;
                        u1 = (tex.getXStart() * widthHW + (x1 - tex0OffsetX)) / widthHW;
                        u2 = (tex.getXStart() * widthHW + (x2 - tex0OffsetX)) / widthHW;
                        u3 = (tex.getXStart() * widthHW + (x3 - tex0OffsetX)) / widthHW;
                        v0 = (tex.getYStart() * heightHW + (y0 - tex0OffsetY)) / heightHW;
                        v1 = (tex.getYStart() * heightHW + (y1 - tex0OffsetY)) / heightHW;
                        v2 = (tex.getYStart() * heightHW + (y2 - tex0OffsetY)) / heightHW;
                        v3 = (tex.getYStart() * heightHW + (y3 - tex0OffsetY)) / heightHW;
                    }
