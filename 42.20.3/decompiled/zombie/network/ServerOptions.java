...
public class ServerOptions {
    ...
    public ServerOptions.IntegerServerOption maxPlayers = new ServerOptions.IntegerServerOption(this, "MaxPlayers", 1, 254, 32);
    ...
    public void init() {
        ...
        if (serverOptsFile.exists()) {
            try {
                ...
                DebugType.General.printException(var4, "Can't load server options", LogSeverity.Error);
            }
    ...
    private static void tryInitSpawnRegionsFile() {
        try {
            ...
            DebugType.General.printException(var3, "Can't initialize spawn regions or spawn points", LogSeverity.Error);
        }
    }
