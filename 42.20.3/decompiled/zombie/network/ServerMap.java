...
public class ServerMap {
    ...
    public void preupdate() {
        ...
        if (!this.toLoad.isEmpty()) {
            ...
            for (int ix = 0; ix < this.toLoad.size(); ix++) {
                ServerMap.ServerCell cell = this.toLoad.get(ix);
            ...
            if (!this.tempCells.isEmpty()) {
                ...
                for (int ixx = 0; ixx < this.tempCells.size(); ixx++) {
                    ServerMap.ServerCell cell = this.tempCells.get(ixx);
            ...
            for (int ixx = 0; ixx < ServerMap.ServerCell.loaded.size(); ixx++) {
                ServerMap.ServerCell cell = ServerMap.ServerCell.loaded.get(ixx);
                if (!cell.doingRecalc) {
