    ...
    public void processClientLoading(UdpConnection connection) {
        switch (this.type) {
            ...
            case PlaceInQueue:
                ...
                LuaEventManager.triggerEvent("OnConnectionStateChanged", "FormatMessage", "PlaceInQueue", this.placeInQueue & 255);
                LoadingQueueState.onPlaceInQueue(this.placeInQueue & 255, data);
        }
    }
