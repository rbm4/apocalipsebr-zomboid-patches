...
public final class Core {
    ...
    public String getVersion() {
        return gameVersion + ".1 " + getGitRevisionString();
    }
    ...
    public String getGitSha() {
        if (this.gitSha == null) {
            this.gitSha = IS_DEV ? DevMainScreenState.getDevSha() : "77d7d5d0d7";
        }
    ...
    public String getGitRevision() {
        if (this.gitRevisionString == null) {
            if (IS_DEV) {
                ...
                this.gitRevisionString = "77d7d5d0d7".substring(0, Math.min("77d7d5d0d7".length(), 20));
            }
        }
    ...
    public static String getGitRevisionString() {
        return IS_DEV ? core.getGitRevision() : "77d7d5d0d7";
    }
