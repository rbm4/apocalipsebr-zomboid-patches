...
public final class ItemContainer {
    ...
    public int getCapacity() {
        ...
        if (this.getVehiclePart() != null) {
            return Math.min(capacity, 3000);
        } else {
            return this.containingItem != null && this.containingItem instanceof InventoryItem ? Math.min(capacity, 100) : Math.min(capacity, 150);
        }
    }
    ...
    public void setCapacity(int capacity) {
        ...
        } else if (this.containingItem != null && this.containingItem instanceof InventoryItem && this.capacity > 100) {
            DebugType.General.warn("Attempting to set capacity of " + this.containingItem + "over maximum capacity of 100");
    ...
    public boolean hasRoomFor(IsoGameCharacter chr, float weightVal, float weightAddedToFloor) {
        if (this.isVehicleSeat()
            ...
            if (chr != null && !this.isInCharacterInventory(chr)) {
                IsoWorldInventoryObject sq = this.getWorldItem();
                if (sq instanceof IsoWorldInventoryObject && sq.getSquare() != null) {
                    IsoGridSquare sqx = sq.getSquare();
                    float ground = sqx.getTotalWeightOfItemsOnFloor();
        ...
        if (item == null) {
            ...
            if (category != null && !category.equalsIgnoreCase(item.getCategory())) {
                ...
                if (this.parent != null && !this.parent.isItemAllowedInContainer(this, item)) {
                    return false;
                } else if (this.isInvalidClothingRackItem(item)) {
                    return false;
                    ...
                    if (this.getParent() != null
                        && this.getParent().getProperties() != null
                        && this.getParent().getProperties().get(IsoPropertyType.GROUP_NAME) != null) {
    ...
    private static boolean isSquarePowered(IsoGridSquare square, boolean includeGenerators) {
        if (square == null) {
            ...
            if (bHydroPower && square.getRoom() != null) {
                return true;
            } else if (includeGenerators && square.haveElectricity()) {
                return true;
            } else {
                if (bHydroPower && square.getRoom() == null) {
    ...
    public static boolean isObjectPowered(IsoObject parent, boolean includeGenerators) {
        if (parent != null && parent.getObjectIndex() != -1) {
            ...
            if (tempObjects.isEmpty()) {
                ...
                for (int ix = 0; ix < tempObjects.size(); ix++) {
                    IsoObject object = tempObjects.get(ix);
    ...
    public float getTemprature() {
        ...
        } else if (!this.isPowered() || !this.isFridge() && !this.isFreezer()) {
    ...
    public String getOpenSound() {
        if (this.openSound == null) {
            VehiclePart var2 = this.getVehiclePart();
            if (var2 instanceof VehiclePart) {
                return var2.getContainerOpenSound();
            } else {
    ...
    public String getCloseSound() {
        if (this.closeSound == null) {
            VehiclePart var2 = this.getVehiclePart();
            if (var2 instanceof VehiclePart) {
                return var2.getContainerCloseSound();
            } else {
                IsoObject parent1 = this.getParent();
    ...
    public String getPutSound() {
        if (this.putSound == null) {
            VehiclePart var2 = this.getVehiclePart();
            if (var2 instanceof VehiclePart) {
                return var2.getContainerPutSound();
            } else {
                IsoObject parent1 = this.getParent();
    ...
    public String getTakeSound() {
        if (this.takeSound == null) {
            VehiclePart var2 = this.getVehiclePart();
            if (var2 instanceof VehiclePart) {
                return var2.getContainerTakeSound();
            } else {
                IsoObject parent1 = this.getParent();
    ...
    public boolean isExistYet() {
        if (!SystemDisabler.doWorldSyncEnable) {
            ...
            return true;
        } else if (this.getVehiclePart() != null) {
            return true;
    ...
    public IsoGridSquare getSquare() {
        ...
        if (outerContainer != null && outerContainer != this) {
            ...
            if (gridSquare != null) {
                ...
                IsoWorldInventoryObject var6 = this.getWorldItem();
                return var6 instanceof IsoWorldInventoryObject ? var6.getSquare() : null;
            }
        }
    }
