...
public class ServerMap {
    ...
    private static final int UNLOAD_PENDING_EMERGENCY = 160;
    private static final int UNLOAD_PENDING_CRITICAL = 192;
    ...
    private static final long UNLOAD_OLDEST_EMERGENCY_MS = DEFERRED_UNLOAD_GRACE_MS * 7L / 2L;
    private static final long UNLOAD_OLDEST_CRITICAL_MS = DEFERRED_UNLOAD_GRACE_MS * 4L;
