...
public final class SpriteRenderer {
    ...
    public static final class RingBuffer {
        ...
        private boolean isStateChanged(
            ...
            if (getTextureId(newTexture0) != getTextureId(this.currentTexture0)) {
                return true;
            }

            if (getTextureId(newTexture1) != getTextureId(this.currentTexture1)) {
                return true;
            }

            if (getTextureId(newTexture2) != getTextureId(this.currentTexture2)) {
                return true;
            }
