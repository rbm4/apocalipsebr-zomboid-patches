    ...
    public void separate() {
        if (this.isSolidForSeparate()) {
            if (this.isPushableForSeparate()) {
                ...
                float selfNextX = this.getNextX();
                float selfNextY = this.getNextY();
                ...
                for (int i = 0; i <= 8; i++) {
                    IsoGridSquare sq = i == 8 ? currentSquare : this.current.getSurroundingSquares()[i];
                                ...
                                if (GameServer.server || this.distToNearestCamCharacter() < 60.0F) {
                                    ...
                                    if (this.isPushedByForSeparate(obj)) {
                                        ...
                                        if (len > 0){
                                            ...
                                            this.setNextX(selfNextX - dx * factor);
                                            this.setNextY(selfNextY - dy * factor);
                                        }
                                    }
