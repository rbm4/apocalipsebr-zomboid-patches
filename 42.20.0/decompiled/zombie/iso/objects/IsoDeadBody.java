...
public final class IsoDeadBody
    ...
    public IsoDeadBody(IsoGameCharacter died, boolean wasCorpseAlready, boolean bAddToSquareAndWorld) {
        ...
        IsoGridSquare realSquare = IsoWorld.instance.currentCell.getGridSquare((double)died.getX(), (double)died.getY(), (double)died.getZ());
            ...
            if (this.sayLine != null) {
                TextManager.instance
                    .DrawStringCentre(
                        ...
                        (double)sy,
                        this.sayLine,
                        (double)this.speakColor.r,
                        (double)this.speakColor.g,
                        (double)this.speakColor.b,
                        (double)this.speakColor.a
                    );
            }
        }
    }
    ...
    public void render(float x, float y, float z, ColorInfo col, boolean bDoChild, boolean bWallLightingPass, Shader shader) {
        if (this.getDoRender()) {
            ...
            if (this.isFakeDead() && DebugOptions.instance.zombieRenderFakeDead.getValue()) {
                ...
                TextManager.instance.DrawStringCentre(UIFont.Medium, (double)sx, (double)sy, String.format("FakeDead %.2f", delay), 1.0, 1.0, 1.0, 1.0);
            }
        ...
        if (this.getContainer() != null && this.getWornItems() != null && this.getAttachedItems() != null) {
            ...
            if (hasInventory) {
                try {
                    ...
                    DebugType.Death.printException(var10, "ReadDeadBodyInventory error for dead body " + this.getCharacterOnlineID(), LogSeverity.Error);
                }
            }
    ...
    public void writeInventory(ByteBufferWriter b) {
        try {
            ...
            DebugType.Death.printException(var9, "WriteInventory error id=" + this.getCharacterOnlineID(), LogSeverity.Error);
        }
    }
    ...
    public boolean canBeGrabbedFrom(float x, float y) {
        return this.canBeGrabbed() && canPickUpBodyFromSquare(this.getCell().getGridSquare((double)x, (double)y, (double)this.getZ()), this.getSquare());
    }
