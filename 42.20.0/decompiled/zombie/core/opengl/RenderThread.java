...
public class RenderThread {
    ...
    private static boolean renderStep() {
        ...
        try {
            ...
            DebugType.General.error("Thrown an " + var3.getClass().getTypeName() + ": " + var3.getMessage());
    ...
    private static void flushInvokeQueue() {
        ...
        try {
            ...
            DebugType.General.printException(var9, LogSeverity.Error, "Thrown an %s: %s ", var9.getClass().getTypeName(), var9.getMessage());
        }
    }
            ...
            if (contextLockReentrantDepth <= 1) {
                ...
                if (isDisplayCreated) {
                    try {
                        ...
                        DebugType.General.printException(var2, LogSeverity.Error, "Exception thrown trying to gain GL context.");
                    }
                }
            }
        }
            ...
            if (contextLockReentrantDepth <= 0) {
                if (isDisplayCreated && hasContext) {
                    try {
                        ...
                        DebugType.General.printException(var2, LogSeverity.Error, "Exception thrown trying to release GL context.");
                    }
                }
