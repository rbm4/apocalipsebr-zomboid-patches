                ...
                if (state1 > 0.0F) {
                    ...
                    TextManager.instance
                        .DrawStringCentre(
                            ...
                            1.0,
                            1.0,
                            (double)IsoUtils.smoothstep(stageStep1 - 0.2F, stageStep1, state1)
                        );
                    y2 += 30;
                    stageStep1 += 0.1F;
                ...
                if (state2 > 0.0F) {
                    ...
                    TextManager.instance
                        .DrawStringCentre(
                            ...
                            1.0,
                            1.0,
                            (double)IsoUtils.smoothstep(stageStep1x - 0.2F, stageStep1x, state2)
                        );
                    y2x += 30;
                    stageStep1x += 0.1F;
                    TextManager.instance
                ...
                if (state3 > 0.0F) {
                    ...
                    TextManager.instance
                        .DrawStringCentre(
                            ...
                            1.0,
                            1.0,
                            (double)IsoUtils.smoothstep(stageStep1x - 0.2F, stageStep1x, state3)
                        );
                    y2x += 30;
                    stageStep1x += 0.1F;
                    TextManager.instance
                ...
                if (state4 > 0.0F) {
                    ...
                    TextManager.instance
                        .DrawStringCentre(
                            ...
                            1.0,
                            1.0,
                            (double)IsoUtils.smoothstep(stageStep1x - 0.2F, stageStep1x, state4)
                        );
                }
            } catch (Exception var21) {
                DebugType.General.printException(var21, "LoadingQueueUI render failed", LogSeverity.Error);
            }
        }
    }
